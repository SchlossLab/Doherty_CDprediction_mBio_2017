...
wk0.all.adiv <- wk046_data[wk046_data$visit=="Screening", c("USUBJID", "visit", "invsimpson", "TRTGR", "RelRSPwk22")]
wk0.adiv <- wk0.all.adiv
colnames(wk0.all.adiv)[3] <- "Week0adiv"
wk0.all.adiv <- subset(wk0.all.adiv, select=-c(visit))

wk4.all.adiv <- wk046_data[wk046_data$visit=="Week 4", c("USUBJID","visit", "invsimpson", "TRTGR", "RelRSPwk22")]
wk4.adiv <- wk4.all.adiv
colnames(wk4.all.adiv)[3] <- "Week4adiv"
wk4.all.adiv <- subset(wk4.all.adiv, select=-c(visit))

wk6.all.adiv <- wk046_data[wk046_data$visit=="Week 6", c("USUBJID","visit", "invsimpson", "TRTGR", "RelRSPwk22")]
