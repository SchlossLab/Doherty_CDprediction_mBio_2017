...
RESPONSEwk6 <- subset(screen_data, select = c(group, RESPONSEwk6))
TRTGR_REMISSwk6 <- subset(screen_data, select = c(group, TRTGR_REMISSwk6))
TRTGR_RESPONSEwk6 <- subset(screen_data, select = c(group, TRTGR_RESPONSEwk6))
...
phyRelab_RESPONSEwk6 <- merge(RESPONSEwk6, phylum_rel_abund, by.y = "row.names", by.x="group")
claRelab_RESPONSEwk6 <- merge(RESPONSEwk6, class_rel_abund, by.y = "row.names", by.x="group")
ordRelab_RESPONSEwk6 <- merge(RESPONSEwk6, order_rel_abund, by.y = "row.names", by.x="group")
famRelab_RESPONSEwk6 <- merge(RESPONSEwk6, family_rel_abund, by.y = "row.names", by.x="group")
otuRelab_RESPONSEwk6 <- merge(RESPONSEwk6, otu_rel_abund, by.y = "row.names", by.x="group")
...
otuRelab_TRTGR_REMISSwk6 <- merge(TRTGR_RESPONSEwk6, otu_rel_abund, by.y = "row.names", by.x="group")

phyRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, phylum_rel_abund, by.y = "row.names", by.x="group")
claRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, class_rel_abund, by.y = "row.names", by.x="group")
ordRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, order_rel_abund, by.y = "row.names", by.x="group")
famRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, family_rel_abund, by.y = "row.names", by.x="group")
otuRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, otu_rel_abund, by.y = "row.names", by.x="group")

REMISSwk22 <- subset(screen_data, select = c(group, REMISSwk22))
RESPONSEwk22 <- subset(screen_data, select = c(group, RESPONSEwk22))
TRTGRINDMAN_REMISSwk22 <- subset(screen_data, select = c(group, TRTGRINDMAN_REMISSwk22))
TRTGRINDMAN_RESPONSEwk22 <- subset(screen_data, select = c(group, TRTGRINDMAN_RESPONSEwk22))
...
phyRelab_RESPONSEwk22 <- merge(RESPONSEwk22, phylum_rel_abund, by.y = "row.names", by.x="group")
claRelab_RESPONSEwk22 <- merge(RESPONSEwk22, class_rel_abund, by.y = "row.names", by.x="group")
ordRelab_RESPONSEwk22 <- merge(RESPONSEwk22, order_rel_abund, by.y = "row.names", by.x="group")
famRelab_RESPONSEwk22 <- merge(RESPONSEwk22, family_rel_abund, by.y = "row.names", by.x="group")
otuRelab_RESPONSEwk22 <- merge(RESPONSEwk22, otu_rel_abund, by.y = "row.names", by.x="group")
...
otuRelab_TRTGRINDMAN_REMISSwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, otu_rel_abund, by.y = "row.names", by.x="group")

phyRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, phylum_rel_abund, by.y = "row.names", by.x="group")
claRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, class_rel_abund, by.y = "row.names", by.x="group")
ordRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, order_rel_abund, by.y = "row.names", by.x="group")
famRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, family_rel_abund, by.y = "row.names", by.x="group")
otuRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, otu_rel_abund, by.y = "row.names", by.x="group")
...
trtd.phyRelab_RESPONSEwk6 <- merge(RESPONSEwk6, trtd.phylum_rel_abund, by.y = "row.names", by.x="group")
trtd.claRelab_RESPONSEwk6 <- merge(RESPONSEwk6, trtd.class_rel_abund, by.y = "row.names", by.x="group")
trtd.ordRelab_RESPONSEwk6 <- merge(RESPONSEwk6, trtd.order_rel_abund, by.y = "row.names", by.x="group")
trtd.famRelab_RESPONSEwk6 <- merge(RESPONSEwk6, trtd.family_rel_abund, by.y = "row.names", by.x="group")
trtd.otuRelab_RESPONSEwk6 <- merge(RESPONSEwk6, trtd.otu_rel_abund, by.y = "row.names", by.x="group")
...
trtd.otuRelab_TRTGR_REMISSwk6 <- merge(TRTGR_RESPONSEwk6, trtd.otu_rel_abund, by.y = "row.names", by.x="group")

trtd.phyRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, trtd.phylum_rel_abund, by.y = "row.names", by.x="group")
trtd.claRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, trtd.class_rel_abund, by.y = "row.names", by.x="group")
trtd.ordRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, trtd.order_rel_abund, by.y = "row.names", by.x="group")
trtd.famRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, trtd.family_rel_abund, by.y = "row.names", by.x="group")
trtd.otuRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, trtd.otu_rel_abund, by.y = "row.names", by.x="group")
...
trtd.phyRelab_RESPONSEwk22 <- merge(RESPONSEwk22, trtd.phylum_rel_abund, by.y = "row.names", by.x="group")
trtd.claRelab_RESPONSEwk22 <- merge(RESPONSEwk22, trtd.class_rel_abund, by.y = "row.names", by.x="group")
trtd.ordRelab_RESPONSEwk22 <- merge(RESPONSEwk22, trtd.order_rel_abund, by.y = "row.names", by.x="group")
trtd.famRelab_RESPONSEwk22 <- merge(RESPONSEwk22, trtd.family_rel_abund, by.y = "row.names", by.x="group")
trtd.otuRelab_RESPONSEwk22 <- merge(RESPONSEwk22, trtd.otu_rel_abund, by.y = "row.names", by.x="group")
...
trtd.otuRelab_TRTGRINDMAN_REMISSwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, trtd.otu_rel_abund, by.y = "row.names", by.x="group")

trtd.phyRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, trtd.phylum_rel_abund, by.y = "row.names", by.x="group")
trtd.claRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, trtd.class_rel_abund, by.y = "row.names", by.x="group")
trtd.ordRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, trtd.order_rel_abund, by.y = "row.names", by.x="group")
trtd.famRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, trtd.family_rel_abund, by.y = "row.names", by.x="group")
trtd.otuRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, trtd.otu_rel_abund, by.y = "row.names", by.x="group")
...
plac.phyRelab_RESPONSEwk6 <- merge(RESPONSEwk6, plac.phylum_rel_abund, by.y = "row.names", by.x="group")
plac.claRelab_RESPONSEwk6 <- merge(RESPONSEwk6, plac.class_rel_abund, by.y = "row.names", by.x="group")
plac.ordRelab_RESPONSEwk6 <- merge(RESPONSEwk6, plac.order_rel_abund, by.y = "row.names", by.x="group")
plac.famRelab_RESPONSEwk6 <- merge(RESPONSEwk6, plac.family_rel_abund, by.y = "row.names", by.x="group")
plac.otuRelab_RESPONSEwk6 <- merge(RESPONSEwk6, plac.otu_rel_abund, by.y = "row.names", by.x="group")
...
plac.otuRelab_TRTGR_REMISSwk6 <- merge(TRTGR_RESPONSEwk6, plac.otu_rel_abund, by.y = "row.names", by.x="group")

plac.phyRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, plac.phylum_rel_abund, by.y = "row.names", by.x="group")
plac.claRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, plac.class_rel_abund, by.y = "row.names", by.x="group")
plac.ordRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, plac.order_rel_abund, by.y = "row.names", by.x="group")
plac.famRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, plac.family_rel_abund, by.y = "row.names", by.x="group")
plac.otuRelab_TRTGR_RESPONSEwk6 <- merge(TRTGR_RESPONSEwk6, plac.otu_rel_abund, by.y = "row.names", by.x="group")
...
plac.phyRelab_RESPONSEwk22 <- merge(RESPONSEwk22, plac.phylum_rel_abund, by.y = "row.names", by.x="group")
plac.claRelab_RESPONSEwk22 <- merge(RESPONSEwk22, plac.class_rel_abund, by.y = "row.names", by.x="group")
plac.ordRelab_RESPONSEwk22 <- merge(RESPONSEwk22, plac.order_rel_abund, by.y = "row.names", by.x="group")
plac.famRelab_RESPONSEwk22 <- merge(RESPONSEwk22, plac.family_rel_abund, by.y = "row.names", by.x="group")
plac.otuRelab_RESPONSEwk22 <- merge(RESPONSEwk22, plac.otu_rel_abund, by.y = "row.names", by.x="group")
...
plac.otuRelab_TRTGRINDMAN_REMISSwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, plac.otu_rel_abund, by.y = "row.names", by.x="group")

plac.phyRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, plac.phylum_rel_abund, by.y = "row.names", by.x="group")
plac.claRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, plac.class_rel_abund, by.y = "row.names", by.x="group")
plac.ordRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, plac.order_rel_abund, by.y = "row.names", by.x="group")
plac.famRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, plac.family_rel_abund, by.y = "row.names", by.x="group")
plac.otuRelab_TRTGRINDMAN_RESPONSEwk22 <- merge(TRTGRINDMAN_RESPONSEwk22, plac.otu_rel_abund, by.y = "row.names", by.x="group")