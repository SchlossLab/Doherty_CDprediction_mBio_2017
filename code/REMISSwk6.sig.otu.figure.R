...
tax_mean_signif_REMISSwk6_otu_matrix <-tax_mean_signif_REMISSwk6_otu_matrix[abs(tax_mean_signif_REMISSwk6_otu_matrix$diff) >= 0.013,]
tax_mean_signif_REMISSwk6_otu_matrix$Label <- factor(tax_mean_signif_REMISSwk6_otu_matrix$Label, levels = as.character(tax_mean_signif_REMISSwk6_otu_matrix$Label), labels= as.character(tax_mean_signif_REMISSwk6_otu_matrix$Label))
tax_mean_signif_REMISSwk6_otu_matrix$OTU <- factor(tax_mean_signif_REMISSwk6_otu_matrix$OTU, levels = as.character(tax_mean_signif_REMISSwk6_otu_matrix$OTU), labels= as.character(tax_mean_signif_REMISSwk6_otu_matrix$OTU))


labeled_mean_signif_REMISSwk6_otu_matrix <- subset(tax_mean_signif_REMISSwk6_otu_matrix, select=c("diff", "Label", "No", "Yes"))
OTU_mean_signif_REMISSwk6_otu_matrix <- subset(tax_mean_signif_REMISSwk6_otu_matrix, select=c("diff", "OTU", "No", "Yes"))
rownames(labeled_mean_signif_REMISSwk6_otu_matrix) <- labeled_mean_signif_REMISSwk6_otu_matrix$Label
labeled_mean_signif_REMISSwk6_otu_matrix <-labeled_mean_signif_REMISSwk6_otu_matrix[abs(labeled_mean_signif_REMISSwk6_otu_matrix$diff) >= 0.013,]
labeled_mean_signif_REMISSwk6_otu_matrix <- labeled_mean_signif_REMISSwk6_otu_matrix[,-c(1:2)]	
rownames(OTU_mean_signif_REMISSwk6_otu_matrix) <- OTU_mean_signif_REMISSwk6_otu_matrix$OTU
OTU_mean_signif_REMISSwk6_otu_matrix <-OTU_mean_signif_REMISSwk6_otu_matrix[abs(OTU_mean_signif_REMISSwk6_otu_matrix$diff) >= 0.013,]
OTU_mean_signif_REMISSwk6_otu_matrix <- OTU_mean_signif_REMISSwk6_otu_matrix[,-c(1:2)]	

#decreasing_order <- order(total_mean_otu_rel_abund, decreasing=T)
#otu_rel_abund <- otu_rel_abund[,decreasing_order]

abund_mean_signif_REMISSwk6_otu_matrix <- data.frame(labeled_mean_signif_REMISSwk6_otu_matrix[labeled_mean_signif_REMISSwk6_otu_matrix$Yes  > 0.001,])

Vabund_mean_signif_REMISSwk6_otu_matrix <- data.frame(labeled_mean_signif_REMISSwk6_otu_matrix[labeled_mean_signif_REMISSwk6_otu_matrix$Yes > 1,])

Mabund_mean_signif_REMISSwk6_otu_matrix <- data.frame(labeled_mean_signif_REMISSwk6_otu_matrix[labeled_mean_signif_REMISSwk6_otu_matrix$Yes  > 0.1,])
Mabund_mean_signif_REMISSwk6_otu_matrix <- data.frame(Mabund_mean_signif_REMISSwk6_otu_matrix[Mabund_mean_signif_REMISSwk6_otu_matrix$Yes < 1,])

Labund_mean_signif_REMISSwk6_otu_matrix <- data.frame(labeled_mean_signif_REMISSwk6_otu_matrix[labeled_mean_signif_REMISSwk6_otu_matrix$Yes > 0.001,])
Labund_mean_signif_REMISSwk6_otu_matrix <- data.frame(Labund_mean_signif_REMISSwk6_otu_matrix[Labund_mean_signif_REMISSwk6_otu_matrix$Yes < 0.1,])
...
rank <- as.character(levels(tax_mean_signif_REMISSwk6_otu_matrix$Label))
otuRabREMISSwk6_ggplot$otu <- factor(otuRabREMISSwk6_ggplot$otu, levels = rank, labels= rank)  #order the subset dataset by the median abundances
otuRabREMISSwk6_ggplot <- otuRabREMISSwk6_ggplot[order(otuRabREMISSwk6_ggplot$otu),]
tail(colnames(otuRabREMISSwk6_ggplot))

tiff('figures/remisswk6byotu.tiff')
ggplot(otuRabREMISSwk6_ggplot, aes(x=REMISSwk6, y=relabund, fill=otu)) +
...
tiff('figures/remisswk6facetotu.tiff', width = 14, height= 5, units="in", res = 300)
...
oturf_otus  <- as.character(ordered(tax_mean_signif_REMISSwk6_otu_matrix$OTU))
