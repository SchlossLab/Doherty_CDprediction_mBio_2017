...
deps = c("AUCRF","pROC", "vegan", "dplyr", 'knitr', "gridExtra", "grid", "devtools", "pgirmess", "knitcitations", "scales");
for (dep in deps){
...
CDAI<- matrix(c('CDAI', CDAI_sum, CDAI_Spear, cdaiwk0.adonis.pval), ncol = 4)
```
...
Stool<- matrix(c('Loose Stool Frequency (per week)', Stool_sum, Stool_Spear, stool.adonis.pval), ncol = 4)
```
...
CRP<- matrix(c('C-Reactive Protein (mg/L serum)', CRP_sum, CRP_Spear, BL_CRP.adonis.pval), ncol = 4)
```
...
FCALP<- matrix(c('Fecal Calprotectin (µg/g)', FCALP_sum, FCALP_Spear, BL_FCALP.adonis.pval), ncol = 4)
```
...
FLACT<- matrix(c('Fecal Lactoferrin (µg/g)', FLACT_sum, FLACT_Spear, BL_FLACT.adonis.pval), ncol = 4)
```
...
BMI<- matrix(c('BMI', BMI_sum, BMI_Spear, BL_BMI.adonis.pval), ncol = 4)
```
...
weight<- matrix(c('Weight (kg)', weight_sum, weight_Spear, CDWEIGHM_Screening.adonis.pval), ncol = 4)
```
...
AGE<- matrix(c('Age (years)', AGE_sum, AGE_Spear, AGE.adonis.pval), ncol = 4)
```
...
SEX<- matrix(c('Sex (F/M)', SEX_sum, wilcox.SEX.pval, SEX.adonis.pval), ncol = 4)
...
BCORT<- matrix(c('Corticosteroid Use (Y/N)', BCORT_sum, wilcox.BCORT.pval, BCORT.adonis.pval), ncol = 4)
```
...
DDUR<- matrix(c('Disease Duration (years)', DDUR_sum, DDUR_Spear_Prho, DDUR.adonis.pval), ncol = 4)
```
...
tissinvol<- matrix(c('Tissue Involvement', tissinvol_sum, kw.tissinvol.pval, tissinvol.adonis.pval), ncol = 4)
```
...
BOWSTRICT<-matrix(c('Bowel Stricture', BOWSTRICT_sum, wilcox.BOWSTRICT.pval, BOWSTRICT.adonis.pval), ncol = 4)
```
...
```{r wk4-diversity, eval=FALSE, include=FALSE}
set.seed(32016)
...
all.YesRESPONSEwk4<-toString(c(all.n.YesRESPONSEwk4.wilcoxtest))
all.YesRESPONSEwk4<-gsub(",", "", all.YesRESPONSEwk4)
all.YesRESPONSEwk4<-gsub(" ", "", all.YesRESPONSEwk4)
all.NoRESPONSEwk4<-toString(c(all.n.NoRESPONSEwk4.wilcoxtest))
all.NoRESPONSEwk4<-gsub(",", "", all.NoRESPONSEwk4)
all.NoRESPONSEwk4<-gsub(" ", "", all.NoRESPONSEwk4)

all.RESPONSEwk4_sum<-toString(c(all.NoRESPONSEwk4, all.YesRESPONSEwk4))
all.RESPONSEwk4_wilcox_P<-toString(c(all.wilcox.RESPONSEwk4.pval))
all.RESPONSEwk4_wilcox_P<-gsub(",", "", all.RESPONSEwk4_wilcox_P)
all.RESPONSEwk4_wilcox_P<-gsub(" ", "", all.RESPONSEwk4_wilcox_P)


all.RESPONSEwk4_AMOVA_p<-toString(c(all.RESPONSEwk4.adonis.pval))
...
trtd.YesRESPONSEwk4<-toString(c(trtd.n.YesRESPONSEwk4.wilcoxtest))
trtd.YesRESPONSEwk4<-gsub(",", "", trtd.YesRESPONSEwk4)
trtd.YesRESPONSEwk4<-gsub(" ", "", trtd.YesRESPONSEwk4)
trtd.NoRESPONSEwk4<-toString(c(trtd.n.NoRESPONSEwk4.wilcoxtest))
trtd.NoRESPONSEwk4<-gsub(",", "", trtd.NoRESPONSEwk4)
trtd.NoRESPONSEwk4<-gsub(" ", "", trtd.NoRESPONSEwk4)

trtd.RESPONSEwk4_sum<-toString(c(trtd.NoRESPONSEwk4, trtd.YesRESPONSEwk4))
trtd.RESPONSEwk4_wilcox_P<-toString(c(trtd.wilcox.RESPONSEwk4.pval))
trtd.RESPONSEwk4_wilcox_P<-gsub(",", "", trtd.RESPONSEwk4_wilcox_P)
trtd.RESPONSEwk4_wilcox_P<-gsub(" ", "", trtd.RESPONSEwk4_wilcox_P)


trtd.RESPONSEwk4_AMOVA_p<-toString(c(trtd.RESPONSEwk4.adonis.pval))
...
plac.YesRESPONSEwk4<-toString(c(plac.n.YesRESPONSEwk4.wilcoxtest))
plac.YesRESPONSEwk4<-gsub(",", "", plac.YesRESPONSEwk4)
plac.YesRESPONSEwk4<-gsub(" ", "", plac.YesRESPONSEwk4)
plac.NoRESPONSEwk4<-toString(c(plac.n.NoRESPONSEwk4.wilcoxtest))
plac.NoRESPONSEwk4<-gsub(",", "", plac.NoRESPONSEwk4)
plac.NoRESPONSEwk4<-gsub(" ", "", plac.NoRESPONSEwk4)

plac.RESPONSEwk4_sum<-toString(c(plac.NoRESPONSEwk4, plac.YesRESPONSEwk4))
plac.RESPONSEwk4_wilcox_P<-toString(c(plac.wilcox.RESPONSEwk4.pval))
plac.RESPONSEwk4_wilcox_P<-gsub(",", "", plac.RESPONSEwk4_wilcox_P)
plac.RESPONSEwk4_wilcox_P<-gsub(" ", "", plac.RESPONSEwk4_wilcox_P)


plac.RESPONSEwk4_AMOVA_p<-toString(c(plac.RESPONSEwk4.adonis.pval))
...
all.YesRelRSPwk4<-toString(c(all.n.YesRelRSPwk4.wilcoxtest))
all.YesRelRSPwk4<-gsub(",", "", all.YesRelRSPwk4)
all.YesRelRSPwk4<-gsub(" ", "", all.YesRelRSPwk4)
all.NoRelRSPwk4<-toString(c(all.n.NoRelRSPwk4.wilcoxtest))
all.NoRelRSPwk4<-gsub(",", "", all.NoRelRSPwk4)
all.NoRelRSPwk4<-gsub(" ", "", all.NoRelRSPwk4)

all.RelRSPwk4_sum<-toString(c(all.NoRelRSPwk4, all.YesRelRSPwk4))
all.RelRSPwk4_wilcox_P<-toString(c(all.wilcox.RelRSPwk4.pval))
all.RelRSPwk4_wilcox_P<-gsub(",", "", all.RelRSPwk4_wilcox_P)
all.RelRSPwk4_wilcox_P<-gsub(" ", "", all.RelRSPwk4_wilcox_P)


all.RelRSPwk4_AMOVA_p<-toString(c(all.RelRSPwk4.adonis.pval))
...
trtd.YesRelRSPwk4<-toString(c(trtd.n.YesRelRSPwk4.wilcoxtest))
trtd.YesRelRSPwk4<-gsub(",", "", trtd.YesRelRSPwk4)
trtd.YesRelRSPwk4<-gsub(" ", "", trtd.YesRelRSPwk4)
trtd.NoRelRSPwk4<-toString(c(trtd.n.NoRelRSPwk4.wilcoxtest))
trtd.NoRelRSPwk4<-gsub(",", "", trtd.NoRelRSPwk4)
trtd.NoRelRSPwk4<-gsub(" ", "", trtd.NoRelRSPwk4)

trtd.RelRSPwk4_sum<-toString(c(trtd.NoRelRSPwk4, trtd.YesRelRSPwk4))
trtd.RelRSPwk4_wilcox_P<-toString(c(trtd.wilcox.RelRSPwk4.pval))
trtd.RelRSPwk4_wilcox_P<-gsub(",", "", trtd.RelRSPwk4_wilcox_P)
trtd.RelRSPwk4_wilcox_P<-gsub(" ", "", trtd.RelRSPwk4_wilcox_P)


trtd.RelRSPwk4_AMOVA_p<-toString(c(trtd.RelRSPwk4.adonis.pval))
...
plac.YesRelRSPwk4<-toString(c(plac.n.YesRelRSPwk4.wilcoxtest))
plac.YesRelRSPwk4<-gsub(",", "", plac.YesRelRSPwk4)
plac.YesRelRSPwk4<-gsub(" ", "", plac.YesRelRSPwk4)
plac.NoRelRSPwk4<-toString(c(plac.n.NoRelRSPwk4.wilcoxtest))
plac.NoRelRSPwk4<-gsub(",", "", plac.NoRelRSPwk4)
plac.NoRelRSPwk4<-gsub(" ", "", plac.NoRelRSPwk4)

plac.RelRSPwk4_sum<-toString(c(plac.NoRelRSPwk4, plac.YesRelRSPwk4))
plac.RelRSPwk4_wilcox_P<-toString(c(plac.wilcox.RelRSPwk4.pval))
plac.RelRSPwk4_wilcox_P<-gsub(",", "", plac.RelRSPwk4_wilcox_P)
plac.RelRSPwk4_wilcox_P<-gsub(" ", "", plac.RelRSPwk4_wilcox_P)


plac.RelRSPwk4_AMOVA_p<-toString(c(plac.RelRSPwk4.adonis.pval))
...
all.YesREMISSwk4<-toString(c(all.n.YesREMISSwk4.wilcoxtest))
all.YesREMISSwk4<-gsub(",", "", all.YesREMISSwk4)
all.YesREMISSwk4<-gsub(" ", "", all.YesREMISSwk4)
all.NoREMISSwk4<-toString(c(all.n.NoREMISSwk4.wilcoxtest))
all.NoREMISSwk4<-gsub(",", "", all.NoREMISSwk4)
all.NoREMISSwk4<-gsub(" ", "", all.NoREMISSwk4)

all.REMISSwk4_sum<-toString(c(all.NoREMISSwk4, all.YesREMISSwk4))
all.REMISSwk4_wilcox_P<-toString(c(all.wilcox.REMISSwk4.pval))
all.REMISSwk4_wilcox_P<-gsub(",", "", all.REMISSwk4_wilcox_P)
all.REMISSwk4_wilcox_P<-gsub(" ", "", all.REMISSwk4_wilcox_P)


all.REMISSwk4_AMOVA_p<-toString(c(all.REMISSwk4.adonis.pval))
...
trtd.YesREMISSwk4<-toString(c(trtd.n.YesREMISSwk4.wilcoxtest))
trtd.YesREMISSwk4<-gsub(",", "", trtd.YesREMISSwk4)
trtd.YesREMISSwk4<-gsub(" ", "", trtd.YesREMISSwk4)
trtd.NoREMISSwk4<-toString(c(trtd.n.NoREMISSwk4.wilcoxtest))
trtd.NoREMISSwk4<-gsub(",", "", trtd.NoREMISSwk4)
trtd.NoREMISSwk4<-gsub(" ", "", trtd.NoREMISSwk4)

trtd.REMISSwk4_sum<-toString(c(trtd.NoREMISSwk4, trtd.YesREMISSwk4))
trtd.REMISSwk4_wilcox_P<-toString(c(trtd.wilcox.REMISSwk4.pval))
trtd.REMISSwk4_wilcox_P<-gsub(",", "", trtd.REMISSwk4_wilcox_P)
trtd.REMISSwk4_wilcox_P<-gsub(" ", "", trtd.REMISSwk4_wilcox_P)


trtd.REMISSwk4_AMOVA_p<-toString(c(trtd.REMISSwk4.adonis.pval))
...
plac.YesREMISSwk4<-toString(c(plac.n.YesREMISSwk4.wilcoxtest))
plac.YesREMISSwk4<-gsub(",", "", plac.YesREMISSwk4)
plac.YesREMISSwk4<-gsub(" ", "", plac.YesREMISSwk4)
plac.NoREMISSwk4<-toString(c(plac.n.NoREMISSwk4.wilcoxtest))
plac.NoREMISSwk4<-gsub(",", "", plac.NoREMISSwk4)
plac.NoREMISSwk4<-gsub(" ", "", plac.NoREMISSwk4)

plac.REMISSwk4_sum<-toString(c(plac.NoREMISSwk4, plac.YesREMISSwk4))
plac.REMISSwk4_wilcox_P<-toString(c(plac.wilcox.REMISSwk4.pval))
plac.REMISSwk4_wilcox_P<-gsub(",", "", plac.REMISSwk4_wilcox_P)
plac.REMISSwk4_wilcox_P<-gsub(" ", "", plac.REMISSwk4_wilcox_P)


plac.REMISSwk4_AMOVA_p<-toString(c(plac.REMISSwk4.adonis.pval))
...
all.RelRSPwk6<-matrix(c('Week 6 Response (Yes, No)', all.RelRSPwk6_sum, all.RelRSPwk6_wilcox_P, all.RelRSPwk6_AMOVA), ncol = 4)
...
all.REMISSwk6<-matrix(c('Week 6 Remission (Yes, No)', all.REMISSwk6_sum, all.REMISSwk6_wilcox_P, all.REMISSwk6_AMOVA), ncol = 4)
...
```{r wk8-diversity, eval=FALSE, include=FALSE}
set.seed(32016)
...
all.YesRESPONSEwk8<-toString(c(all.n.YesRESPONSEwk8.wilcoxtest))
all.YesRESPONSEwk8<-gsub(",", "", all.YesRESPONSEwk8)
all.YesRESPONSEwk8<-gsub(" ", "", all.YesRESPONSEwk8)
all.NoRESPONSEwk8<-toString(c(all.n.NoRESPONSEwk8.wilcoxtest))
all.NoRESPONSEwk8<-gsub(",", "", all.NoRESPONSEwk8)
all.NoRESPONSEwk8<-gsub(" ", "", all.NoRESPONSEwk8)

all.RESPONSEwk8_sum<-toString(c(all.NoRESPONSEwk8, all.YesRESPONSEwk8))
all.RESPONSEwk8_wilcox_P<-toString(c(all.wilcox.RESPONSEwk8.pval))
all.RESPONSEwk8_wilcox_P<-gsub(",", "", all.RESPONSEwk8_wilcox_P)
all.RESPONSEwk8_wilcox_P<-gsub(" ", "", all.RESPONSEwk8_wilcox_P)


all.RESPONSEwk8_AMOVA_p<-toString(c(all.RESPONSEwk8.adonis.pval))
...
trtd.YesRESPONSEwk8<-toString(c(trtd.n.YesRESPONSEwk8.wilcoxtest))
trtd.YesRESPONSEwk8<-gsub(",", "", trtd.YesRESPONSEwk8)
trtd.YesRESPONSEwk8<-gsub(" ", "", trtd.YesRESPONSEwk8)
trtd.NoRESPONSEwk8<-toString(c(trtd.n.NoRESPONSEwk8.wilcoxtest))
trtd.NoRESPONSEwk8<-gsub(",", "", trtd.NoRESPONSEwk8)
trtd.NoRESPONSEwk8<-gsub(" ", "", trtd.NoRESPONSEwk8)

trtd.RESPONSEwk8_sum<-toString(c(trtd.NoRESPONSEwk8, trtd.YesRESPONSEwk8))
trtd.RESPONSEwk8_wilcox_P<-toString(c(trtd.wilcox.RESPONSEwk8.pval))
trtd.RESPONSEwk8_wilcox_P<-gsub(",", "", trtd.RESPONSEwk8_wilcox_P)
trtd.RESPONSEwk8_wilcox_P<-gsub(" ", "", trtd.RESPONSEwk8_wilcox_P)


trtd.RESPONSEwk8_AMOVA_p<-toString(c(trtd.RESPONSEwk8.adonis.pval))
...
plac.YesRESPONSEwk8<-toString(c(plac.n.YesRESPONSEwk8.wilcoxtest))
plac.YesRESPONSEwk8<-gsub(",", "", plac.YesRESPONSEwk8)
plac.YesRESPONSEwk8<-gsub(" ", "", plac.YesRESPONSEwk8)
plac.NoRESPONSEwk8<-toString(c(plac.n.NoRESPONSEwk8.wilcoxtest))
plac.NoRESPONSEwk8<-gsub(",", "", plac.NoRESPONSEwk8)
plac.NoRESPONSEwk8<-gsub(" ", "", plac.NoRESPONSEwk8)

plac.RESPONSEwk8_sum<-toString(c(plac.NoRESPONSEwk8, plac.YesRESPONSEwk8))
plac.RESPONSEwk8_wilcox_P<-toString(c(plac.wilcox.RESPONSEwk8.pval))
plac.RESPONSEwk8_wilcox_P<-gsub(",", "", plac.RESPONSEwk8_wilcox_P)
plac.RESPONSEwk8_wilcox_P<-gsub(" ", "", plac.RESPONSEwk8_wilcox_P)


plac.RESPONSEwk8_AMOVA_p<-toString(c(plac.RESPONSEwk8.adonis.pval))
...
all.YesRelRSPwk8<-toString(c(all.n.YesRelRSPwk8.wilcoxtest))
all.YesRelRSPwk8<-gsub(",", "", all.YesRelRSPwk8)
all.YesRelRSPwk8<-gsub(" ", "", all.YesRelRSPwk8)
all.NoRelRSPwk8<-toString(c(all.n.NoRelRSPwk8.wilcoxtest))
all.NoRelRSPwk8<-gsub(",", "", all.NoRelRSPwk8)
all.NoRelRSPwk8<-gsub(" ", "", all.NoRelRSPwk8)

all.RelRSPwk8_sum<-toString(c(all.NoRelRSPwk8, all.YesRelRSPwk8))
all.RelRSPwk8_wilcox_P<-toString(c(all.wilcox.RelRSPwk8.pval))
all.RelRSPwk8_wilcox_P<-gsub(",", "", all.RelRSPwk8_wilcox_P)
all.RelRSPwk8_wilcox_P<-gsub(" ", "", all.RelRSPwk8_wilcox_P)


all.RelRSPwk8_AMOVA_p<-toString(c(all.RelRSPwk8.adonis.pval))
...
trtd.YesRelRSPwk8<-toString(c(trtd.n.YesRelRSPwk8.wilcoxtest))
trtd.YesRelRSPwk8<-gsub(",", "", trtd.YesRelRSPwk8)
trtd.YesRelRSPwk8<-gsub(" ", "", trtd.YesRelRSPwk8)
trtd.NoRelRSPwk8<-toString(c(trtd.n.NoRelRSPwk8.wilcoxtest))
trtd.NoRelRSPwk8<-gsub(",", "", trtd.NoRelRSPwk8)
trtd.NoRelRSPwk8<-gsub(" ", "", trtd.NoRelRSPwk8)

trtd.RelRSPwk8_sum<-toString(c(trtd.NoRelRSPwk8, trtd.YesRelRSPwk8))
trtd.RelRSPwk8_wilcox_P<-toString(c(trtd.wilcox.RelRSPwk8.pval))
trtd.RelRSPwk8_wilcox_P<-gsub(",", "", trtd.RelRSPwk8_wilcox_P)
trtd.RelRSPwk8_wilcox_P<-gsub(" ", "", trtd.RelRSPwk8_wilcox_P)


trtd.RelRSPwk8_AMOVA_p<-toString(c(trtd.RelRSPwk8.adonis.pval))
...
plac.YesRelRSPwk8<-toString(c(plac.n.YesRelRSPwk8.wilcoxtest))
plac.YesRelRSPwk8<-gsub(",", "", plac.YesRelRSPwk8)
plac.YesRelRSPwk8<-gsub(" ", "", plac.YesRelRSPwk8)
plac.NoRelRSPwk8<-toString(c(plac.n.NoRelRSPwk8.wilcoxtest))
plac.NoRelRSPwk8<-gsub(",", "", plac.NoRelRSPwk8)
plac.NoRelRSPwk8<-gsub(" ", "", plac.NoRelRSPwk8)

plac.RelRSPwk8_sum<-toString(c(plac.NoRelRSPwk8, plac.YesRelRSPwk8))
plac.RelRSPwk8_wilcox_P<-toString(c(plac.wilcox.RelRSPwk8.pval))
plac.RelRSPwk8_wilcox_P<-gsub(",", "", plac.RelRSPwk8_wilcox_P)
plac.RelRSPwk8_wilcox_P<-gsub(" ", "", plac.RelRSPwk8_wilcox_P)


plac.RelRSPwk8_AMOVA_p<-toString(c(plac.RelRSPwk8.adonis.pval))
...
all.YesREMISSwk8<-toString(c(all.n.YesREMISSwk8.wilcoxtest))
all.YesREMISSwk8<-gsub(",", "", all.YesREMISSwk8)
all.YesREMISSwk8<-gsub(" ", "", all.YesREMISSwk8)
all.NoREMISSwk8<-toString(c(all.n.NoREMISSwk8.wilcoxtest))
all.NoREMISSwk8<-gsub(",", "", all.NoREMISSwk8)
all.NoREMISSwk8<-gsub(" ", "", all.NoREMISSwk8)

all.REMISSwk8_sum<-toString(c(all.NoREMISSwk8, all.YesREMISSwk8))
all.REMISSwk8_wilcox_P<-toString(c(all.wilcox.REMISSwk8.pval))
all.REMISSwk8_wilcox_P<-gsub(",", "", all.REMISSwk8_wilcox_P)
all.REMISSwk8_wilcox_P<-gsub(" ", "", all.REMISSwk8_wilcox_P)


all.REMISSwk8_AMOVA_p<-toString(c(all.REMISSwk8.adonis.pval))
...
trtd.YesREMISSwk8<-toString(c(trtd.n.YesREMISSwk8.wilcoxtest))
trtd.YesREMISSwk8<-gsub(",", "", trtd.YesREMISSwk8)
trtd.YesREMISSwk8<-gsub(" ", "", trtd.YesREMISSwk8)
trtd.NoREMISSwk8<-toString(c(trtd.n.NoREMISSwk8.wilcoxtest))
trtd.NoREMISSwk8<-gsub(",", "", trtd.NoREMISSwk8)
trtd.NoREMISSwk8<-gsub(" ", "", trtd.NoREMISSwk8)

trtd.REMISSwk8_sum<-toString(c(trtd.NoREMISSwk8, trtd.YesREMISSwk8))
trtd.REMISSwk8_wilcox_P<-toString(c(trtd.wilcox.REMISSwk8.pval))
trtd.REMISSwk8_wilcox_P<-gsub(",", "", trtd.REMISSwk8_wilcox_P)
trtd.REMISSwk8_wilcox_P<-gsub(" ", "", trtd.REMISSwk8_wilcox_P)


trtd.REMISSwk8_AMOVA_p<-toString(c(trtd.REMISSwk8.adonis.pval))
...
plac.YesREMISSwk8<-toString(c(plac.n.YesREMISSwk8.wilcoxtest))
plac.YesREMISSwk8<-gsub(",", "", plac.YesREMISSwk8)
plac.YesREMISSwk8<-gsub(" ", "", plac.YesREMISSwk8)
plac.NoREMISSwk8<-toString(c(plac.n.NoREMISSwk8.wilcoxtest))
plac.NoREMISSwk8<-gsub(",", "", plac.NoREMISSwk8)
plac.NoREMISSwk8<-gsub(" ", "", plac.NoREMISSwk8)

plac.REMISSwk8_sum<-toString(c(plac.NoREMISSwk8, plac.YesREMISSwk8))
plac.REMISSwk8_wilcox_P<-toString(c(plac.wilcox.REMISSwk8.pval))
plac.REMISSwk8_wilcox_P<-gsub(",", "", plac.REMISSwk8_wilcox_P)
plac.REMISSwk8_wilcox_P<-gsub(" ", "", plac.REMISSwk8_wilcox_P)


plac.REMISSwk8_AMOVA_p<-toString(c(plac.REMISSwk8.adonis.pval))
...
```{r RESPONSEwk4-AUC-RF, eval=FALSE, fig.height=5, fig.width=10, include=FALSE}
set.seed(32016)
...
```{r RelRSPwk4-AUC-RF, eval=FALSE, fig.height=5, fig.width=10, include=FALSE}
...
```{r REMISSwk4-AUC-RF, eval=FALSE, fig.height=5, fig.width=10, include=FALSE}
...
```{r RESPONSEwk8-AUC-RF, eval=FALSE, fig.height=5, fig.width=10, include=FALSE}
...
```{r RelRSPwk8-AUC-RF, eval=FALSE, fig.height=5, fig.width=10, include=FALSE}
...
```{r REMISSwk8-AUC-RF, eval=FALSE, fig.height=5, fig.width=10, include=FALSE}
...
```{r TRTGR_RelRSPwk8.trtdYN.lefse, eval=FALSE, fig.height=5, fig.width=10, fill=T, header=T, include=FALSE, na.strings=c("NA", "NULL"), sep="\t"}
...
###Introduction
Crohn’s disease (CD), an incurable inflammatory bowel disease (IBD), is a global health issue with increasing incidence. CD affects approximately 3 million people worldwide, causing large economic and healthcare utilization impacts on society [@Ananthakrishnan_2015; @Floyd_2014; @Molodecky_2012]. CD is characterized by patches of ulceration and inflammation affecting the entire bowel wall along the gastrointestinal tract, most commonly in the ileum and colon. Individuals with CD experience frequent diarrhea, abdominal pain, fatigue, and weight loss resulting in significant health care costs, lower quality of life, and economic impacts due to loss of productivity [@Floyd_2014; @Mantzaris_2015; @Randall_2015] (2, 4, 5). Current treatments for CD include antibiotics, anti-inflammatory drugs, immunomodulators, surgery, and biologic agents targeting tumor necrosis factor alpha (TNF-${\alpha}$), such as Infliximab (Remicade). Within 10 years of diagnosis, approximately half of individuals with CD will require surgery and the majority will experience escalating immunosuppressive treatment [@Boyapati_2015] (6). Currently, individuals with CD are treated based on disease location and risk of complications using escalating immunosuppressive treatment and/or surgery with the goal of achieving and sustaining remission [@Randall_2015; @Wils_2016] (5, 7). Faster induction of remission following diagnosis reduces the risk of irreversible intestinal damage and disability [@Wils_2016; @Colombel_2015; @Baert_2010] (7-9). Anti-TNF-${\alpha}$ therapy in combination with thiopurines has emerged as the preferred treatment for CD, but up to half of individuals with CD fail to respond or lose response to anti-TNF-${\alpha}$ therapy [@Boyapati_2015; @Wils_2016] (6, 7). Ustekinumab (UST), a monoclonal antibody directed against the shared p40 subunit of IL-12 and IL-23, has been proposed as an alternative therapy for these patients [@Sandborn_2012] (10). While clinical trials have demonstrated that UST is a viable option for the treatment of CD [@Wils_2016; @Sandborn_2012; @Sandborn_2008; @Kopylov_2014] (7, 10-12), some patients within these trials were non-responsive to UST, which may be explained by differences in the patients’ gut microbiomes.
