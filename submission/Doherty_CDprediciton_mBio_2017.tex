...
## AUC of selected variables: OOB-AUCopt= 0.8244263 
## AUC from cross validation: 0.6429265 
## Importance Measure: MDA 
## 
##    Selected.Variables   Importance Prob.Select
## 1            Otu00330 0.0020440151        0.87
## 2            Otu00007 0.0013891462        0.94
## 3            Otu00265 0.0012265706        0.74
## 4            Otu00001 0.0011944571        0.55
## 5            Otu00491 0.0010294392        0.60
## 6            Otu00035 0.0009488290        0.35
## 7            Otu00155 0.0008142554        0.49
## 8            Otu00108 0.0007405366        0.32
## 9            Otu00085 0.0006494931        0.15
## 10           Otu00222 0.0006027025        0.38
## 11           Otu00189 0.0006016933        0.67
## 12           Otu00397 0.0005926151        0.50
## 13           Otu00162 0.0005873496        0.61
## 14           Otu00117 0.0005574939        0.42
## 15           Otu00024 0.0005384343        0.12
## 16           Otu00065 0.0005281717        0.10
## 17           Otu00008 0.0004963119        0.08
\end{verbatim}
...
\begin{verbatim}
## 
## Number of selected variables: Kopt= 27 
## AUC of selected variables: OOB-AUCopt= 0.8530816 
## AUC from cross validation: 0.5939562 
## Importance Measure: MDA 
## 
##    Selected.Variables   Importance Prob.Select
## 1            Otu00051 0.0023898112        0.88
## 2            Otu00007 0.0017983906        0.62
## 3            Otu00203 0.0016930285        0.79
## 4            Otu00153 0.0016022333        0.69
## 5            Otu00090 0.0013977738        0.62
## 6              DDUR10 0.0013482662        0.22
## 7            Otu00092 0.0012398159        0.54
## 8            Otu00117 0.0011798518        0.28
## 9            Otu00232 0.0010933402        0.63
## 10           Otu00130 0.0009899458        0.76
## 11           Otu00108 0.0009321826        0.43
## 12           Otu00140 0.0008788320        0.33
## 13           Otu00324 0.0008639187        0.23
## 14           Otu00151 0.0008524008        0.20
## 15           Otu00104 0.0008481433        0.21
## 16             BL_BMI 0.0008417439        0.06
## 17           Otu00041 0.0008257700        0.35
## 18           Otu00353 0.0007896517        0.13
## 19         invsimpson 0.0007782257        0.27
## 20           Otu00095 0.0007356034        0.02
## 21           Otu00079 0.0007212451        0.36
## 22           Otu00339 0.0007009694        0.41
## 23           Otu00060 0.0006887950        0.40
## 24           Otu00003 0.0006863465        0.13
## 25           Otu00043 0.0006795474        0.27
## 26           Otu00161 0.0006773303        0.03
## 27             BL_CRP 0.0006742888        0.34
\end{verbatim}
...
predict response, the model predicted response with an AUC of 0.691 with
a specificity of 0.727 and a sensitivity of 0.634. Using only microbiome
...
of 0.755 with a specificity of 0.6 and a sensitivity of 0.829. With
respect to Week 6 remission, using solely clinical metadata we achieved
AUC of 0.619 with a specificity of 0.488 and a sensitivity of 0.742.
...
metadata with the microbiome AUC of 0.824 with a specificity of 0.677
and a sensitivity of 0.903.
...
\textbf{ST2: adonis summary table showing difference by
visit/TRTGR/wk22resp} includegraphics\{tables/SF2adonis.pdf
...
week 6 remission}
\includegraphics{figures/ggplot.phylum.figure.byRelRSPwk6.pdf}
\includegraphics{figures/ggplot.phylum.figure.byREMISSwk6.pdf}

\newpage
*

*SF 1: Phyla by response/remission week 22**
\includegraphics{figures/ggplot.phylum.figure.byRelRSPwk22.pdf}
\includegraphics{figures/ggplot.phylum.figure.byREMISSwk22.pdf} \newpage

\textbf{Figure 2: Change in alpha diversity over time}
...
abunds** \includegraphics{figures/Figure3.pdf}
...
\textbf{Supplemental Figure 3: Predicting Week 22 disease status using
Week 0 samples}
