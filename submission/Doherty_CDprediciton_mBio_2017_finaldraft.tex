...
monitoring a patient's response to UST. (word count= 244/250,
TextWrangler)
...
gastrointestinal diseases. (word count =94/150, TextWrangler)
...
model and the combined model (p = 0.841).
...
induction. Clinical data alone resulted in an AUC of 0.651 (specificity
= 0.545, sensitivity = 0.724) (Figure 2C). Using only microbiota data,
the model predicted response with an AUC of 0.762 (specificity = 0.558,
...
time (p = 0.012) having increased from baseline (median = 6.65, IQR =
4.60 - 9.24) to 4 weeks after UST induction(median = 9.33, IQR = 6.54 -
...
diseases (7--10), if fecal microbiota can be validated as biomarkers to
non-invasively predict response to therapy, then patients and clinicians
will be able to more rapidly ascertain effective therapies that result
