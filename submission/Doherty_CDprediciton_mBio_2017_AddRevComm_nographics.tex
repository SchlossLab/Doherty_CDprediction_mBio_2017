...
concomitant medication handling are described in the `Methods/Patients'
section of the clinical study (37). Subject data was de-identified for
our study. Participants provided a stool sample prior to the initiation
of the study and were then divided into treatment groups. An additional
...
\textbf{Table 1: Summary of clinical metadata of cohort at
baseline}\footnotemark

\includegraphics{tables/Table1_baseline_metadata.pdf}

\footnotetext{No significant differences were observed between placebo and treated groups for sex (p = 0.31), corticosterioid use (p = 0.06), or tissue involment (p > 0.05).}
